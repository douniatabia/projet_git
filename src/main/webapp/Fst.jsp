      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="loginfst.jsp">Acceuil</a></li>
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Fst</li>
          </ol>
           <c:out  value="Bienvenue ${nom}"></c:out>
        </nav>
                ...
                <li class="mb-2">
                  <a class="dropdown-item border-radius-md" href="javascript:;">
                    <div class="d-flex py-1">
                      <div class="my-auto">
                        <img src="template/img/team-2.jpg" class="avatar avatar-sm  me-3 ">
                      </div>
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize">Etudiant</p>
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize">Filieres</p>
                <c:out  value="${count1}"></c:out >
              </div>
            </div>
        <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
