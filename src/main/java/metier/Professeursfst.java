...
@WebServlet("/Professeursfst")
public class Professeursfst extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public Professeursfst() {
        super();  }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
	    	...
	    	String sql="select * from f1_fst"; //professeurs
			ResultSet resultat;
		...
		RequestDispatcher dispatchar=request.getRequestDispatcher("Professeursfst.jsp");
