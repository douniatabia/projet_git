...
@WebServlet("/Profgiidest")
public class Profgiidest extends HttpServlet {
	private static final long serialVersionUID = 1L;
    
    public Profgiidest() {       super();      }
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
	    	...
	    	String sql="select * from f9_est"; //professeurs
			ResultSet resultat;
		...
		RequestDispatcher dispatchar=request.getRequestDispatcher("Profgiidest.jsp");
